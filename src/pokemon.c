...
// megas lza
#define CRY_SPECIES_BASE_RAICHU_X (CRY_SPECIES_FORMS_BASE+25 + 48)
#define CRY_SPECIES_BASE_RAICHU_Y (CRY_SPECIES_FORMS_BASE+26 + 48)
#define CRY_SPECIES_BASE_CLEFABLE (CRY_SPECIES_FORMS_BASE+27 + 48)
#define CRY_SPECIES_BASE_VICTREEBEL (CRY_SPECIES_FORMS_BASE+28 + 48)
#define CRY_SPECIES_BASE_STARMIE (CRY_SPECIES_FORMS_BASE+29 + 48)
#define CRY_SPECIES_BASE_DRAGONITE (CRY_SPECIES_FORMS_BASE+30 + 48)
#define CRY_SPECIES_BASE_MEGANIUM (CRY_SPECIES_FORMS_BASE+31 + 48)
#define CRY_SPECIES_BASE_FERALIGATR (CRY_SPECIES_FORMS_BASE+32 + 48)
#define CRY_SPECIES_BASE_SKARMORY (CRY_SPECIES_FORMS_BASE+33 + 48)
#define CRY_SPECIES_BASE_CHIMECHO (CRY_SPECIES_FORMS_BASE+34 + 48)
#define CRY_SPECIES_BASE_ABSOL_Z (CRY_SPECIES_FORMS_BASE+35 + 48)
#define CRY_SPECIES_BASE_STARAPTOR (CRY_SPECIES_FORMS_BASE+36 + 48)
#define CRY_SPECIES_BASE_GARCHOMP_Z (CRY_SPECIES_FORMS_BASE+37 + 48)
#define CRY_SPECIES_BASE_LUCARIO_Z (CRY_SPECIES_FORMS_BASE+38 + 48)
#define CRY_SPECIES_BASE_FROSLASS (CRY_SPECIES_FORMS_BASE+39 + 48)
#define CRY_SPECIES_BASE_HEATRAN (CRY_SPECIES_FORMS_BASE+40 + 48)
#define CRY_SPECIES_BASE_DARKRAI (CRY_SPECIES_FORMS_BASE+41 + 48)
#define CRY_SPECIES_BASE_EMBOAR (CRY_SPECIES_FORMS_BASE+42 + 48)
#define CRY_SPECIES_BASE_EXCADRILL (CRY_SPECIES_FORMS_BASE+43 + 48)
#define CRY_SPECIES_BASE_SCOLIPEDE (CRY_SPECIES_FORMS_BASE+44 + 48)
#define CRY_SPECIES_BASE_SCRAFTY (CRY_SPECIES_FORMS_BASE+45 + 48)
#define CRY_SPECIES_BASE_EELEKTROSS (CRY_SPECIES_FORMS_BASE+46 + 48)
#define CRY_SPECIES_BASE_CHANDELURE (CRY_SPECIES_FORMS_BASE+47 + 48)
#define CRY_SPECIES_BASE_GOLURK (CRY_SPECIES_FORMS_BASE+48 + 48)
#define CRY_SPECIES_BASE_CHESNAUGHT (CRY_SPECIES_FORMS_BASE+49 + 48)
#define CRY_SPECIES_BASE_DELPHOX (CRY_SPECIES_FORMS_BASE+50 + 48)
#define CRY_SPECIES_BASE_GRENINJA (CRY_SPECIES_FORMS_BASE+51 + 48)
#define CRY_SPECIES_BASE_PYROAR (CRY_SPECIES_FORMS_BASE+52 + 48)
#define CRY_SPECIES_BASE_PYROAR_FEMALE (CRY_SPECIES_FORMS_BASE+53 + 48)
#define CRY_SPECIES_BASE_FLOETTE_ETERNAL_FLOWER (CRY_SPECIES_FORMS_BASE+54 + 48)
#define CRY_SPECIES_BASE_MEOWSTIC (CRY_SPECIES_FORMS_BASE+55 + 48)
#define CRY_SPECIES_BASE_MEOWSTIC_FEMALE (CRY_SPECIES_FORMS_BASE+56 + 48)
#define CRY_SPECIES_BASE_MALAMAR (CRY_SPECIES_FORMS_BASE+57 + 48)
#define CRY_SPECIES_BASE_BARBARACLE (CRY_SPECIES_FORMS_BASE+58 + 48)
#define CRY_SPECIES_BASE_DRAGALGE (CRY_SPECIES_FORMS_BASE+59 + 48)
#define CRY_SPECIES_BASE_HAWLUCHA (CRY_SPECIES_FORMS_BASE+60 + 48)
#define CRY_SPECIES_BASE_ZYGARDE_10_COMPLETE (CRY_SPECIES_FORMS_BASE+61 + 48)
#define CRY_SPECIES_BASE_ZYGARDE_50_COMPLETE (CRY_SPECIES_FORMS_BASE+62 + 48)
#define CRY_SPECIES_BASE_CRABOMINABLE (CRY_SPECIES_FORMS_BASE+63 + 48)
#define CRY_SPECIES_BASE_GOLISOPOD (CRY_SPECIES_FORMS_BASE+64 + 48)
#define CRY_SPECIES_BASE_DRAMPA (CRY_SPECIES_FORMS_BASE+65 + 48)
#define CRY_SPECIES_BASE_MAGEARNA (CRY_SPECIES_FORMS_BASE+66 + 48)
#define CRY_SPECIES_BASE_MAGEARNA_ORIGINAL (CRY_SPECIES_FORMS_BASE+67 + 48)
#define CRY_SPECIES_BASE_ZERAORA (CRY_SPECIES_FORMS_BASE+68 + 48)
#define CRY_SPECIES_BASE_FALINKS (CRY_SPECIES_FORMS_BASE+69 + 48)
#define CRY_SPECIES_BASE_SCOVILLAIN (CRY_SPECIES_FORMS_BASE+70 + 48)
#define CRY_SPECIES_BASE_GLIMMORA (CRY_SPECIES_FORMS_BASE+71 + 48)
#define CRY_SPECIES_BASE_TATSUGIRI (CRY_SPECIES_FORMS_BASE+72 + 48)
#define CRY_SPECIES_BASE_TATSUGIRI_DROOPY (CRY_SPECIES_FORMS_BASE+73 + 48)
#define CRY_SPECIES_BASE_TATSUGIRI_STRETCHY (CRY_SPECIES_FORMS_BASE+74 + 48)
#define CRY_SPECIES_BASE_BAXCALIBUR (CRY_SPECIES_FORMS_BASE+75 + 48)
