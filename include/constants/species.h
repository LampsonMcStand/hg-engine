...
#define SPECIES_MEGA_RAICHU_X (SPECIES_PALDEAN_FORMS_START + 39)
#define SPECIES_MEGA_RAICHU_Y (SPECIES_PALDEAN_FORMS_START + 40)
#define SPECIES_MEGA_CLEFABLE (SPECIES_PALDEAN_FORMS_START + 41)
#define SPECIES_MEGA_VICTREEBEL (SPECIES_PALDEAN_FORMS_START + 42)
#define SPECIES_MEGA_STARMIE (SPECIES_PALDEAN_FORMS_START + 43)
#define SPECIES_MEGA_DRAGONITE (SPECIES_PALDEAN_FORMS_START + 44)
#define SPECIES_MEGA_MEGANIUM (SPECIES_PALDEAN_FORMS_START + 45)
#define SPECIES_MEGA_FERALIGATR (SPECIES_PALDEAN_FORMS_START + 46)
#define SPECIES_MEGA_SKARMORY (SPECIES_PALDEAN_FORMS_START + 47)
#define SPECIES_MEGA_CHIMECHO (SPECIES_PALDEAN_FORMS_START + 48)
#define SPECIES_MEGA_ABSOL_Z (SPECIES_PALDEAN_FORMS_START + 49)
#define SPECIES_MEGA_STARAPTOR (SPECIES_PALDEAN_FORMS_START + 50)
#define SPECIES_MEGA_GARCHOMP_Z (SPECIES_PALDEAN_FORMS_START + 51)
#define SPECIES_MEGA_LUCARIO_Z (SPECIES_PALDEAN_FORMS_START + 52)
#define SPECIES_MEGA_FROSLASS (SPECIES_PALDEAN_FORMS_START + 53)
#define SPECIES_MEGA_HEATRAN (SPECIES_PALDEAN_FORMS_START + 54)
#define SPECIES_MEGA_DARKRAI (SPECIES_PALDEAN_FORMS_START + 55)
#define SPECIES_MEGA_EMBOAR (SPECIES_PALDEAN_FORMS_START + 56)
#define SPECIES_MEGA_EXCADRILL (SPECIES_PALDEAN_FORMS_START + 57)
#define SPECIES_MEGA_SCOLIPEDE (SPECIES_PALDEAN_FORMS_START + 58)
#define SPECIES_MEGA_SCRAFTY (SPECIES_PALDEAN_FORMS_START + 59)
#define SPECIES_MEGA_EELEKTROSS (SPECIES_PALDEAN_FORMS_START + 60)
#define SPECIES_MEGA_CHANDELURE (SPECIES_PALDEAN_FORMS_START + 61)
#define SPECIES_MEGA_GOLURK (SPECIES_PALDEAN_FORMS_START + 62)
#define SPECIES_MEGA_CHESNAUGHT (SPECIES_PALDEAN_FORMS_START + 63)
#define SPECIES_MEGA_DELPHOX (SPECIES_PALDEAN_FORMS_START + 64)
#define SPECIES_MEGA_GRENINJA (SPECIES_PALDEAN_FORMS_START + 65)
#define SPECIES_MEGA_PYROAR (SPECIES_PALDEAN_FORMS_START + 66)
#define SPECIES_MEGA_PYROAR_FEMALE (SPECIES_PALDEAN_FORMS_START + 67)
#define SPECIES_MEGA_FLOETTE_ETERNAL_FLOWER (SPECIES_PALDEAN_FORMS_START + 68)
#define SPECIES_MEGA_MEOWSTIC (SPECIES_PALDEAN_FORMS_START + 69)
#define SPECIES_MEGA_MEOWSTIC_FEMALE (SPECIES_PALDEAN_FORMS_START + 70)
#define SPECIES_MEGA_MALAMAR (SPECIES_PALDEAN_FORMS_START + 71)
#define SPECIES_MEGA_BARBARACLE (SPECIES_PALDEAN_FORMS_START + 72)
#define SPECIES_MEGA_DRAGALGE (SPECIES_PALDEAN_FORMS_START + 73)
#define SPECIES_MEGA_HAWLUCHA (SPECIES_PALDEAN_FORMS_START + 74)
#define SPECIES_MEGA_ZYGARDE_10_COMPLETE (SPECIES_PALDEAN_FORMS_START + 75)
#define SPECIES_MEGA_ZYGARDE_50_COMPLETE (SPECIES_PALDEAN_FORMS_START + 76)
#define SPECIES_MEGA_CRABOMINABLE (SPECIES_PALDEAN_FORMS_START + 77)
#define SPECIES_MEGA_GOLISOPOD (SPECIES_PALDEAN_FORMS_START + 78)
#define SPECIES_MEGA_DRAMPA (SPECIES_PALDEAN_FORMS_START + 79)
#define SPECIES_MEGA_MAGEARNA (SPECIES_PALDEAN_FORMS_START + 80)
#define SPECIES_MEGA_MAGEARNA_ORIGINAL (SPECIES_PALDEAN_FORMS_START + 81)
#define SPECIES_MEGA_ZERAORA (SPECIES_PALDEAN_FORMS_START + 82)
#define SPECIES_MEGA_FALINKS (SPECIES_PALDEAN_FORMS_START + 83)
#define SPECIES_MEGA_SCOVILLAIN (SPECIES_PALDEAN_FORMS_START + 84)
#define SPECIES_MEGA_GLIMMORA (SPECIES_PALDEAN_FORMS_START + 85)
#define SPECIES_MEGA_TATSUGIRI (SPECIES_PALDEAN_FORMS_START + 86)
#define SPECIES_MEGA_TATSUGIRI_DROOPY (SPECIES_PALDEAN_FORMS_START + 87)
#define SPECIES_MEGA_TATSUGIRI_STRETCHY (SPECIES_PALDEAN_FORMS_START + 88)
#define SPECIES_MEGA_BAXCALIBUR (SPECIES_PALDEAN_FORMS_START + 89)

#define MAX_SPECIES_INCLUDING_FORMS (SPECIES_MEGA_BAXCALIBUR)  // 1393
